            ...
            for janela_rsi in janela_rsi_vals:
                for ordem in ordem_vals:
                    for lookback in lookback_vals:
                        print(f'Simulação {contador} para: Ativo={ticker_clean}, num_pontos={num_pontos}, janela_rsi={janela_rsi}, ordem={ordem}, lookback = {lookback}, d_max={d_max}, break_min={break_min}, aplicar_log={aplicar_log}')
                        contador = contador + 1
