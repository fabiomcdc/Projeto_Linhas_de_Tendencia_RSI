...
file_name = f'simulacoes_realizadas/simulacoes_out_of_sample_validacao/resultados_consolidados_validacao.csv'
...
for i, cenario in enumerate(cenarios):
    ...
    file_name = f'simulacoes_realizadas/simulacoes_out_of_sample_validacao/dispersao_cenario_{cenario}.png'
...
file_name = f'simulacoes_realizadas/simulacoes_out_of_sample_validacao/dispersão_cenario_todos_cenarios.png'
