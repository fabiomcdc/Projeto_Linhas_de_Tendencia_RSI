# ------------------------------------------------------------------------
#  A rotina simula_cenarios_acoes simula todas as três fases do
#  processo: in_sample => out_of_sample_validacao => out_of_sample_final
# ------------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# início da simulação dos intervalos in_sample fase 1
# ---------------------------------------------------------------------
...
# construção do nome da simulação
...
# definição do nome do folder onde os dados serão guardados
...
#     melhores_resultados_cenario_in_sample.to_csv(file_name_resultado_media_in_sample_1x, sep=";", decimal=",", index=True, encoding="utf-8")
    ...
    folder_path_melhores_resultados = f'simulacoes_realizadas/simulacoes_in_sample'
    file_name_melhores_resultados = f'{folder_path_melhores_resultados}/melhores_resultados.csv'
    melhores_resultados = pd.read_csv(file_name_melhores_resultados, sep=";", decimal=",", index_col=0, encoding="utf-8")

    # melhor_break_min_in_sample_1 =  melhores_resultados.loc[melhores_resultados['ativo'] == ticker_clean, melhores_resultados['variavel'] == 'break_min'].values[0]
    # melhor_janela_rsi_in_sample_1 = melhores_resultados.loc[melhores_resultados['ativo'] == ticker_clean, melhores_resultados['variavel'] == 'janela_rsi'].values[0]
    # melhor_ordem_in_sample_1 = melhores_resultados.loc[melhores_resultados['ativo'] == ticker_clean, melhores_resultados['variavel'] == 'ordem'].values[0]
    # melhor_num_pontos_in_sample_1 = melhores_resultados.loc[melhores_resultados['ativo'] == ticker_clean, melhores_resultados['variavel'] == 'num_pontos'].values[0]
    # melhor_lookback_in_sample_1 = melhores_resultados.loc[melhores_resultados['ativo'] == ticker_clean, melhores_resultados['variavel'] == 'lookback'].values[0]
    melhor_break_min_in_sample_1 = melhores_resultados.loc[
        (melhores_resultados['ativo'] == ticker_clean) & (melhores_resultados['variavel'] == 'break_min'),
        'melhor_valor'
        ].values[0]

    melhor_janela_rsi_in_sample_1 = melhores_resultados.loc[
        (melhores_resultados['ativo'] == ticker_clean) & (melhores_resultados['variavel'] == 'janela_rsi'),
        'melhor_valor'
    ].values[0]

    melhor_ordem_in_sample_1 = melhores_resultados.loc[
        (melhores_resultados['ativo'] == ticker_clean) & (melhores_resultados['variavel'] == 'ordem'),
        'melhor_valor'
    ].values[0]

    melhor_num_pontos_in_sample_1 = melhores_resultados.loc[
        (melhores_resultados['ativo'] == ticker_clean) & (melhores_resultados['variavel'] == 'num_pontos'),
        'melhor_valor'
    ].values[0]

    melhor_lookback_in_sample_1 = melhores_resultados.loc[
        (melhores_resultados['ativo'] == ticker_clean) & (melhores_resultados['variavel'] == 'lookback'),
        'melhor_valor'
    ].values[0]
    melhor_sl_in_sample_1 = 0.02
    melhor_pt_in_sample_1 = 0.05
    ...
    for cenario in cenarios_simulados:  # Roda os cenários previstos em cenario_in_sample_1x
        ...
        resultado_simulado = processa_simulacao(ticker,
            ...
            imprime_grafico,
            salva_dados,
            folder_path_melhores_resultados)
    ...
    folder_path = f'simulacoes_realizadas/simulacoes_out_of_sample_validacao/{ticker_clean}'
    ...
    # Supondo que resultados_cenario_validacao é um DataFrame definido anteriormente
