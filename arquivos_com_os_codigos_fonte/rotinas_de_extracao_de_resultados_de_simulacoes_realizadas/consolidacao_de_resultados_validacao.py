...
# Consolidando todos os resultados a partir de simulacoes_realizadas/simulacoes_out_of_sample_validacao ---------------------------------------------------------
...
folder_path = f'simulacoes_realizadas/simulacoes_out_of_sample_validacao'
...
for ativo in ativo_vals: # aqui começa o loop ativo a ativo
    ...
    # Consolidando melhores resultados a partir de simulacoes_realizadas/simulacoes_out_of_sample_validacao ---------------------------------------------------------
