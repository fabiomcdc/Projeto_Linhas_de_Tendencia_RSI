...
for ativo in ativo_vals: # aqui começa o loop ativo a ativo
    ...
    # simulações_aplicadas_a_ativos_teste_ordem ---------------------------------------------------------
    
    folder_path = f'simulações_aplicadas_a_ativos_teste_ordem/{ticker_clean}'
...
file_name_resultados = f'simulações_aplicadas_a_ativos_teste_ordem/resultados_in_sample_1.csv'
...
file_name = f'simulações_aplicadas_a_ativos_teste_ordem/retorno_anual_por_ordem.png'
...
file_name = f'simulações_aplicadas_a_ativos_teste_ordem/num_trades_por_ordem.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
file_name = f'simulações_aplicadas_a_ativos_teste_ordem/sharpe_ratio_por_ordem.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
file_name = f'simulações_aplicadas_a_ativos_teste_ordem/max_drawdown_por_ordem.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI