...
for ativo in ativo_vals: # aqui começa o loop ativo a ativo
    ...
    # simulações_aplicadas_a_ativos_teste_num_pontos ---------------------------------------------------------
    
    folder_path = f'simulações_aplicadas_a_ativos_teste_num_pontos_2/{ticker_clean}'
    ...
    # simulações_aplicadas_a_ativos_teste_num_pontos_4 ---------------------------------------------------------
    
    folder_path = f'simulações_aplicadas_a_ativos_teste_num_pontos_4/{ticker_clean}'
    file_name = f'{folder_path}/{ticker_clean}_cenario_in_sample_1x_resultados.csv'
    ...
    # simulações_aplicadas_a_ativos_teste_num_pontos_3 ---------------------------------------------------------

folder_path = f'simulações_aplicadas_a_ativos_teste_num_pontos_3'
file_name = f'{folder_path}/resultados_in_sample_1_num_pontos_3.csv'
...
file_name_resultados = f'simulações_aplicadas_a_ativos_teste_num_pontos_resultados/resultados_in_sample_1.csv'
...
file_name = f'simulações_aplicadas_a_ativos_teste_num_pontos_resultados/retorno_anual_por_num_pontos.png'
...
file_name = f'simulações_aplicadas_a_ativos_teste_num_pontos_resultados/num_trades_por_num_pontos.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
file_name = f'simulações_aplicadas_a_ativos_teste_num_pontos_resultados/sharpe_ratio_por_num_pontos.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
file_name = f'simulações_aplicadas_a_ativos_teste_num_pontos_resultados/max_drawdown_por_num_pontos.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI