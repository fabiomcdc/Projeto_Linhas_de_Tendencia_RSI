...
for ativo in ativo_vals: # aqui começa o loop ativo a ativo
    ...
    # simulações_aplicadas_a_ativos_teste_d_max ---------------------------------------------------------
    
    folder_path = f'simulações_aplicadas_a_ativos_teste_d_max_1/{ticker_clean}'
...
folder_path = f'simulações_aplicadas_a_ativos_teste_d_max_2'
file_name = f'{folder_path}/resultados_in_sample_1_d_max_2.csv'
...
file_name_resultados = f'simulações_aplicadas_a_ativos_teste_d_max_resultados/resultados_in_sample_1.csv'
...
resultados_consolidados.boxplot(column='return_ann', by='d_max', grid=False, showfliers=True)
...
file_name = f'simulações_aplicadas_a_ativos_teste_d_max_resultados/retorno_anual_por_d_max.png'
...
resultados_consolidados.boxplot(column='trades', by='d_max', grid=False, showfliers=True)
...
file_name = f'simulações_aplicadas_a_ativos_teste_d_max_resultados/num_trades_por_d_max.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
resultados_consolidados.boxplot(column='sharpe_ratio', by='d_max', grid=False, showfliers=True)
...
file_name = f'simulações_aplicadas_a_ativos_teste_d_max_resultados/sharpe_ratio_por_d_max.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI
...
resultados_consolidados.boxplot(column='max_drawdown', by='d_max', grid=False, showfliers=True)
...
file_name = f'simulações_aplicadas_a_ativos_teste_d_max_resultados/max_drawdown_por_d_max.png'
plt.savefig(file_name, dpi=300)  # Salva como PNG com resolução de 300 DPI