...
# ---------------------------------------------------------------------
#  Fazendo as 3 simulações In_Sample
# ---------------------------------------------------------------------

# intervalo_simulado_vals = [ 3, 4, 5, 6, 7, 8 ]
# intervalo_simulado_vals = [ 1, 2 ]
intervalo_simulado_vals = [ 0 ]
# intervalo_simulado_vals = [ 7, 8 ]
...
for intervalo_simulado in intervalo_simulado_vals:
    ...
    match intervalo_simulado:
        ...
        case 0: # ------------ Teste Unitári com gráfico ----------------------------------
            ...
            file_name_tipo_intervalo = f'cenário_escolhido'
